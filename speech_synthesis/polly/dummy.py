...
if __name__ == "__main__":
    ...
    audacity.import_file("F:/Inoft/skill_histoire_decryptage_1/inoft_vocal_framework/speech_synthesis/polly/leo.mp3", track_number=1)
    audacity.import_file("F:/Inoft/skill_histoire_decryptage_1/inoft_vocal_framework/speech_synthesis/polly/willie.mp3", track_number=2)
