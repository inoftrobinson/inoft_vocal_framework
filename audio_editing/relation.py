from inoft_vocal_engine.exceptions import raise_if_variable_not_expected_type_and_not_none
...
class RelationProps:
    ...
    @parent_item.setter
    def parent_item(self, parent_item) -> None:
    ...
    @property
    def seconds_child_start_after_parent_end(self) -> int or float:
        return self._seconds_child_start_after_parent_end

    @seconds_child_start_after_parent_end.setter
    def seconds_child_start_after_parent_end(self, seconds_child_start_after_parent_end: int or float) -> None:
        self._seconds_child_start_after_parent_end = seconds_child_start_after_parent_end

    @property
    def seconds_child_end_after_parent_end(self) -> int or float:
        return self._seconds_child_end_after_parent_end

    @seconds_child_end_after_parent_end.setter
    def seconds_child_end_after_parent_end(self, seconds_child_end_after_parent_end: int or float) -> None:
        self._seconds_child_end_after_parent_end = seconds_child_end_after_parent_end


class Relation(RelationProps):
    def __init__(self, parent_item, seconds_child_start_after_parent_start: float = None, seconds_child_start_after_parent_end: float = None,
