...
from inoft_vocal_engine.inoft_vocal_framework.botpress_integration.templates.templates_access import TemplatesAccess
...
class GeneratorCore:
    ...
    def process_on_enter(self, actions_list: list) -> list:
        ...
        from inoft_vocal_engine.inoft_vocal_framework.plugins.OfficialAudioFilesInsteadOfText import Core as PluginCore
