...
from inoft_vocal_engine.inoft_vocal_framework.utils.general import is_text_ssml
...
class Directives(list):
    ...
    def audioPlayer(self):
        from inoft_vocal_engine.inoft_vocal_framework.platforms_handlers.alexa.audioplayer import AudioPlayer
