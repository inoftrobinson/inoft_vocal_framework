...
from inoft_vocal_engine.inoft_vocal_framework.platforms_handlers.alexa.audioplayer import AudioPlayerWrapper
from inoft_vocal_engine.inoft_vocal_framework.platforms_handlers.alexa.context import Context
from inoft_vocal_engine.inoft_vocal_framework.platforms_handlers.alexa import Request
from inoft_vocal_engine.inoft_vocal_framework.platforms_handlers.alexa.response import Response
from inoft_vocal_engine.inoft_vocal_framework.platforms_handlers.alexa import Session
...
class AlexaHandlerInput:
    ...
    def show_basic_card(self, title: str, text: str, small_image_url: Optional[str] = None, large_image_url: Optional[str] = None) -> None:
        from inoft_vocal_engine.inoft_vocal_framework.platforms_handlers.alexa.response import Card
        if small_image_url is not None or large_image_url is not None:
            from inoft_vocal_engine.inoft_vocal_framework.platforms_handlers.alexa.response import Image
