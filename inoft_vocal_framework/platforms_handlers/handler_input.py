...
from inoft_vocal_engine.inoft_vocal_framework.platforms_handlers.current_used_platform_info import CurrentUsedPlatformInfo
from inoft_vocal_engine.databases.dynamodb.dynamodb import DynamoDbAttributesAdapter, DynamoDbNotificationsSubscribers
from inoft_vocal_engine.inoft_vocal_framework.platforms_handlers import NotificationsSubscribers
...
class HandlerInput(CurrentUsedPlatformInfo):
    ...
    def persistent_user_id(self) -> str:
        if not isinstance(self._persistent_user_id, str) or (self._persistent_user_id.replace(" ", "") == ""):
            ...
            if not isinstance(user_id, str) or user_id.replace(" ", "") == "":
                from inoft_vocal_engine.inoft_vocal_framework.utils.general import generate_uuid4
    ...
    def load_event(self, event: dict) -> None:
        if self.is_alexa is True:
            from inoft_vocal_engine.inoft_vocal_framework.platforms_handlers.alexa.handler_input import AlexaHandlerInput
            ...
            from inoft_vocal_engine.inoft_vocal_framework.platforms_handlers.dialogflow.handler_input import DialogFlowHandlerInput
            ...
            from inoft_vocal_engine.inoft_vocal_framework.platforms_handlers.samsungbixby import BixbyHandlerInput
    ...
    def memorize_session_then_state(self, state_handler_class_type_or_name) -> None:
        from inoft_vocal_engine.inoft_vocal_framework.skill_builder.inoft_skill_builder import InoftStateHandler
    ...
    def memorize_session_last_intent_handler(self, handler_class_type_instance_name) -> None:
        from inoft_vocal_engine.inoft_vocal_framework.skill_builder.inoft_skill_builder import InoftRequestHandler, InoftStateHandler
    ...
    def to_platform_dict(self) -> dict:
        ...
        if self.is_alexa is True:
            ...
            from inoft_vocal_engine.inoft_vocal_framework.platforms_handlers.dialogflow import OutputContextItem
