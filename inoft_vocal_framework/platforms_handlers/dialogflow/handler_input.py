...
from inoft_vocal_engine.inoft_vocal_framework.platforms_handlers.dialogflow import Request
from inoft_vocal_engine.inoft_vocal_framework.platforms_handlers.dialogflow import Response, Image, ImageDisplayOptions
...
class DialogFlowHandlerInput(SurfaceCapabilities):
    ...
    def show_basic_card(self, title: str = None, subtitle: str = None, content_formatted_text: str = None,
        ...
        from inoft_vocal_engine.inoft_vocal_framework.platforms_handlers.dialogflow import BasicCard
