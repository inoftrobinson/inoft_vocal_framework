...
@cli.command("new")
def new():
    from inoft_vocal_engine.inoft_vocal_framework.cli import new as new_module
    new_module.new()

@cli.command("deploy")
def deploy():
    from inoft_vocal_engine.inoft_vocal_framework.cli import DeployHandler as deployHandler
...
@botpress.command()
def text_to_audio():
    from inoft_vocal_engine.inoft_vocal_framework.cli.botpress import BotpressCore
