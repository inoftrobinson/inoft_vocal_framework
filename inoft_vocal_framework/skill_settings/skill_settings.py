...
from inoft_vocal_engine.inoft_vocal_framework.skill_settings import Deployment
from inoft_vocal_engine.inoft_vocal_framework.skill_settings import DatabaseSessionsUsersData, \
    DatabaseMessagesContent, DatabaseUsersNotificationsSubscriptions
from inoft_vocal_engine.inoft_vocal_framework.skill_settings import Plugins
...
def prompt_get_settings(root_folderpath: Optional[str] = None) -> Settings:
    ...
    if root_folderpath is None:
        from inoft_vocal_engine.inoft_vocal_framework.cli.components import current_project_directory
