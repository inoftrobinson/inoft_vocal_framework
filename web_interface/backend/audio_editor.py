...
def audio_editor(project_id: str):
    audio_project_data, audio_request_success = project_resources.audio_editor_projects_dynamodb_client.get_project_data_by_project_id(project_id=project_id)
    text_project_data, text_request_success = project_resources.project_text_contents_dynamodb_client.get_by_id(project_id=project_id)
...
def audio_editor_save(project_id: str):
    ...
    if request_json_data is not None:
        request_success = project_resources.audio_editor_projects_dynamodb_client.save_project_data(project_id=project_id,
