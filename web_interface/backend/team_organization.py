...
def organization(project_id: str):
    project_data, request_success = StaticClients().team_organization_projects_dynamodb_static_client.get_project_data_by_project_id(project_id=project_id)
...
def organization_save(project_id: str):
    ...
    StaticClients().team_organization_projects_dynamodb_static_client.save_project_data(project_id=project_id, project_data=request_json_data)
