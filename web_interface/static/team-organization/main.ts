import {initializeHistoryManagement} from "./ganttUtils.js";
import {GanttMaster} from "./ganttMaster.js";
declare let ge: GanttMaster;
declare const project_id: string;
declare const resumed_project_data: any;
...
function saveGanttOnServer() {
  let prj: GanttMaster = ge.saveGantt();
  ...
  */
  ...
  $.ajax({
      ...
      success: function (response_data: any) {
          console.log("Yay");
      }
  })
